...
cntrlObject.controller('signupcontroller',["domoExamService", "$scope",
                                           function(domoExamService, $scope) 
                                           {
...
.controller('examcontroller',["examService","$scope", "$routeParams", "$window", "$rootScope","$timeout",
                              function(examService, $scope, $routeParams, $window, $rootScope,$timeout)
                              {
